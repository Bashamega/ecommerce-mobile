...
export function Menu({active, navigation}:{active:number, navigation:any}){
    return(
        <Div className="p-5 bg-[#F69F21] absolute left-0 bottom-0 w-full rounded-t-2xl flex-row justify-evenly">
            ...
            <Ionicons name="extension-puzzle-outline" size={30} color={active == 4?"white":"black"}/>
            ...
            <Feather name="menu" size={24} color={active == 4?"white":"black"} onPress={()=>{navigation?.navigate("settings")}} />
        </Div>
    )
}
