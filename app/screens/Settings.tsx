...
export function Settings({ navigation }: { navigation: any }) {
  ...
  return (
    <Div
      className="relative h-full w-screen bg-[#FFFBF5] items-center"
      style={{
    ...
    >
      ...
      <Scroll className=" bg-white w-[80%] rounded-2xl mt-[-50px] p-5 gap-5">
        ...
        <Div className=" flex-row items-center relative border-b-2 border-[#F69F21CF]">
          ...
          <P className=" p-1 px-2 rounded-full text-center bg-[#F69F211F] text-[#F69F21CF] absolute right-2 text-[8px]">
            3
          </P>
          <FontisIcon
            className=" absolute right-0"
        ...
        <Div className=" flex-row items-center relative border-b-2 border-[#F69F21CF]">
          ...
          <P className="p-1  rounded-full text-center bg-[#F69F211F] text-[#755E5E] absolute right-2 text-[8px]">
            English
          </P>
          <FontisIcon
            className=" absolute right-0"
