import { Div, Scroll, Icon, P, Img, AntiIcon } from "../components/TailwindComponents";
  ...
  return (
    ...
    >
      <Scroll >
        <Div>
          ...
          <Div className=" bg-white py-5 px-10 border-y border-slate-400 flex-row space-x-1">
            <Div className=" rounded-lg p-[1px] w-1/4 h-24 bg-[#F69F21]">
              <Img source={require("../../assets/tracking.jpeg")} className=" rounded-lg w-full h-full" />
            </Div>
            <Div className="w-3/4">
              ...
              <P className="font-bold">ZAGATTO Messenger bag, a spacious messenger bag</P>
        ...
        <Div className="p-5">
          ...
          <Div className="flex-row gap-2">
            ...
            <Div>
              <P className="text-[#F69F21] font-bold text-lg">Order Dispatched</P>
          ...
          <Div className="flex-row gap-2">
            ...
            <Div>
              <P className="text-[#F69F21] font-bold text-lg">Order in Transit</P>
          ...
          <Div className="flex-row gap-2 items-center">
            ...
            <Div>
              <P className="text-[#04040454] font-bold text-lg">Delivered Sucessfully</P>
            </Div>
          </Div>
          <Div className=" h-20 border-l-4 ml-12 border-[#F69F21] w-20"/>
        </Div>
      ...
      <Div className=" absolute bottom-0 p-5 border-t w-full border-slate-400 bg-white flex-row space-x-1 items-center">
        ...
        <Div>
          <P className="text-[#F69F21] text-lg font-bold">Don’t forget to rate</P>
